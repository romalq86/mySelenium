...
//		driver.get(WebElementCommandDemo2.URL);
//		WebElement element=driver.findElement(By.xpath("//input[@type='text']"));
//		element.sendKeys(WebElementCommandDemo2.USERNAME);
//		Thread.sleep(3000);
//		element.findElement(By.xpath("//input [@id='txtPassword']"));
//		element.sendKeys(WebElementCommandDemo2.PASS);
//		element.findElement(By.xpath("//input[@id='btnLogin']")).click();
